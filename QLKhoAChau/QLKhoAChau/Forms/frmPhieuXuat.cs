...
namespace QLKhoAChau.Forms
{
    public class frmPhieuXuat : Form
    {
        ...
        public frmPhieuXuat()
        {
            ...
            cboKH = new ComboBox { Location = new Point(100, y), Width = 330, DropDownStyle = ComboBoxStyle.DropDownList };
            gb.Controls.Add(cboKH); y += 32;
            ...
            cboHH.SelectedIndexChanged += (s,e) => {
                if (cboHH.SelectedItem is DataRowView drv) txtDonGia.Text = drv["GiaBan"].ToString();
            };
        ...
        void BtnAddItem_Click(object sender, EventArgs e)
        {
            ...
            if (sl > ton) { MessageBox.Show($"Tồn kho hiện chỉ còn {ton}!"); return; }
